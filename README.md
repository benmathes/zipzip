...
get the app created:
    ...
    $ heroku apps:create zipzip
    Creating zipzip... done, stack is cedar
    http://zipzip.herokuapp.com/ | git@heroku.com:zipzip.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://zipzip.herokuapp.com deployed to Heroku

    To git@heroku.com:zipzip.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://zipzip.herokuap.com
    ["Hello" :from Heroku]
